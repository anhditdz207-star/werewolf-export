...
export interface GameUiState {
  ...
  /** This night's confirmed actions so far — dead-spectator catch-up list. */
  nightActionLog: NightActionConfirmedPayload[];
...
type Action =
  ...
  | { type: 'NIGHT_ACTION_CONFIRMED'; payload: NightActionConfirmedPayload }
  | { type: 'NIGHT_ACTION_LOG'; payload: NightActionLogPayload }
  ...
  | { type: 'VOTE_RESULT'; payload: VoteResultPayload }
...
function reducer(state: GameUiState, action: Action): GameUiState {
  switch (action.type) {
    ...
    case 'NIGHT_ACTION_CONFIRMED':
      return {
        ...state,
        nightActionConfirmed: action.payload,
        nightActionLog: [...state.nightActionLog, action.payload],
      };
    case 'NIGHT_ACTION_LOG':
      return { ...state, nightActionLog: action.payload.entries };
    case 'SEER_RESULT':
    ...
    case 'DAY_REVEAL':
      return { ...state, lastDayReveal: action.payload, nightPrompt: null, maidNightPrompt: null, nightActionLog: [] };
    case 'VOTE_TALLY':
      return { ...state, voteTally: action.tally };
    case 'VOTE_RESULT':
      return { ...state, lastVoteResult: action.payload, voteTally: {} };
    case 'HUNTER_PROMPT':
